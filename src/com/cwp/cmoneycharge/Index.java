...
public class Index extends Activity {
	...
	int returnflag;
	// 定义字符串数组，存储系统功能
	String[] titles = new String[] { "  账户支出", "账户收入", "消费便签", "统计分析", "账户管理",
			"系统设置", "退出管家","系统信息" };
	// 定义int数组，存储功能对应的图标
	int[] images = new int[] { R.drawable.pay,
			R.drawable.income, R.drawable.note,
			R.drawable.data, R.drawable.account, R.drawable.setting,
			R.drawable.exit, R.drawable.setting_1 };
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		requestWindowFeature(Window.FEATURE_CUSTOM_TITLE);
		setContentView(R.layout.activity_index);
		getWindow().setFeatureInt(Window.FEATURE_CUSTOM_TITLE, R.layout.title_01);
		...
		gvInfo.setOnItemClickListener(new OnItemClickListener() {// 为GridView设置项单击事件
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
				...
				case 6: //退出
					...
					break;
				case 7	: //about system
                    intent = new Intent(Index.this,About.class);
					intent.putExtra("cwp.id",userid);
					startActivity(intent);
					break;
